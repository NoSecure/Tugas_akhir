                    ...
                    ?>
						...
						<div class="form-group">
 						...
 						<div class="form-group">
							...
							<input type="text" name="nama_barang" id="nama_barang" value="<?php echo $e['nama_barang'];?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Harga</label>
							<input type="text" name="harga_satuan" id="harga_satuan" value="<?php echo $e['harga_satuan'];?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Stock</label>
							<input type="text" name="stock_barang" id="stock_barang" value="<?php if($e['stock_barang']<1){echo "Habis";} else{echo $e['stock_barang']; } ?>" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="keterangan" id="keterangan" rows="5"><?php echo $e['keterangan'];?></textarea>
						</div>
						<div class="form-group">
