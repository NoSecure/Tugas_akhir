			...
			<div class="col-md-12">
				<div class="box">
					...
					<form action="aksi.php" method="post" enctype="multipart/form-data">
								...
								?>
						<div class="col-md-6">
						<input type="hidden" name="pemilik" id="pemilik" value="<?php echo $pemilik?>" class="form-control">
						<div class="form-group">
							<label>Kode Barang</label>
							<input type="text" name="kd_barang" id="kd_barang" readonly value="<?php echo $id_barang ?>" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Harga</label>
							<input type="text" name="harga_satuan" id="harga_satuan" class="form-control" placeholder="Enter ...">
						</div>
						<div class="form-group">
							<label>Stock</label>
							<input type="text" name="stock_barang" id="stock_barang" class="form-control" placeholder="Enter ...">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="keterangan" id="keterangan" rows="5" placeholder="Enter ..."></textarea>
						</div>
						<div class="form-group">
