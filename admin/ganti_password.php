...
<body class="theme-red">
    ...
    <section class="content" style="margin-left:600px; margin-right:350px;">
        <div class="container-fluid">
                        ...
                        <div class="body">
                            <form action="proses_edit_akun.php" method="post" enctype="multipart/form-data">
								<div class="col-md-6">
									...
									<button type="submit" name="simpan" id="simpan" class="btn btn-success m-t-15 waves-effect">Simpan</button>
                                </div>  
							</form>
						</div>
					</div>
						...
						<form action="aksi_akun.php" method="post" id="form1" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="username" placeholder="Masukan username" name="username" value="">
                                </div>
							     <div class="form-group">
                                    <label for="nama">Password</label>
                                    <input type="password" class="form-control" id="password" placeholder="Masukan password" name="password" value="">
                                </div>
                                 <div class="form-group">
