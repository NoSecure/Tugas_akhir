                ...
                <div class="col-md-12">
                    <div class="card col-md-12">
                        <div class="body">
                                <?php 
                                    include"koneksi.php";
                                    $edit=$koneksi->query("select*from users where id_member='$_GET[kd]'");
                                    $e=mysqli_fetch_array($edit);
                                ?>
								<div class="col-md-6">
                                    <label for="kd_barang">Id Member</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="id_pesanan" disabled value="<?php echo $e['id_member'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="nama_barang">Nama</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_pemesan" disabled value="<?php echo $e['nama'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="tolol">Email</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_barang" disabled class="form-control" value="<?php echo $e['email'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Level</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="total" disabled class="form-control" value="<?php echo $e['level'];?>">
                                        </div>
                                    </div>
                                    <a href="delete_member.php?kd=<?php echo $e['id'];?>"><button type="button" class="btn btn-success m-t-15 waves-effect">Hapus</button></a>
									<a href="daftar_member.php"><button type="button" class="btn btn-primary m-t-15 waves-effect">Keluar</button></a>
									</div>
									<div class="col-md-6"><br>
										<label for="tolol">Foto Member</label>
