                ...
                <div class="col-md-12">
                    <div class="card col-md-12">
                        <div class="body">
                            ...
                            <form>
								<div class="col-md-6">
                                    <input type="hidden" name="id" disabled value="<?php echo $e['id_pesanan'];?>" class="form-control">
                                    <label for="kd_barang">Id Pesanan</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="id_pesanan" disabled value="<?php echo $e['id_pesanan'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="nama_barang">Nama Pemesan</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_pemesan" disabled value="<?php echo $e['nama_pemesan'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="tolol">Kode Barang</label>
									<div class="form-group">
                                        <div class="form-line">
                                        <a href="view-detail.php?kd=<?php echo $e['kd_barang'];?>"><input type="text" name="kd_barang" disabled id="kd_barang" class="form-control" value="<?php echo $e['kd_barang'];?>"  style="cursor:pointer;"></a>
                                        </div>
                                    </div>
									<label for="tolol">Quantity</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="quantity" disabled class="form-control" value="<?php echo $e['quantity'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Total</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="total" disabled class="form-control" value="<?php echo number_format($total,3,",",","); ?>">
                                        </div>
                                    </div>
									<label for="tolol">Alamat</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="alamat" disabled class="form-control" value="<?php echo $e['alamat'];?>">
                                        </div>
                                    </div>
									<label for="tolol">No Telepon</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="no_tlpn" disabled class="form-control" value="<?php echo $e['no_tlpn'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Tanggal</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="tanggal" disabled class="form-control" value="<?php echo $e['tanggal'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Metode Pembayaran</label>
									<div class="form-group">
                                        <div class="form-line">
											 <input type="text" name="metode_pembayaran" disabled class="form-control" value="<?php echo $e['metode_pembayaran'];?>">
                                        </div>
                                    </div>
									<br>
                                    <a href="delete_pemesanan.php?kd=<?php echo $e['id'];?>"><button type="button" class="btn btn-success m-t-15 waves-effect">Hapus</button></a>
									<a href="pemesanan.php"><button type="button" class="btn btn-primary m-t-15 waves-effect">Keluar</button></a>
									</div>
