                    ...
                    <div class="card col-md-12">
                        <div class="body">
                            <form action="update.php" method="post" enctype="multipart/form-data">
                                ...
                                ?>
								<div class="col-md-6">
                                    <input type="hidden" name="id" disabled value="<?php echo $e['id'];?>" class="form-control">
                                    <label for="kd_barang">Kode Barang</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="kd_barang" disabled value="<?php echo $e['kd_barang'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="nama_barang">Nama Barang</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_barang" disabled value="<?php echo $e['nama_barang'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="tolol">Harga</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="harga_satuan" disabled id="" class="form-control" value="<?php echo $e['harga_satuan'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Stock</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="stock_barang" disabled class="form-control" value="<?php if($e['stock_barang']<1){echo "Habis";} else{echo $e['stock_barang']; } ?>">
                                        </div>
                                    </div>
                                    <label for="tolol">Kategori</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="kategori" disabled class="form-control" value="<?php echo $e['kategori'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Keterangan</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <textarea cols="30" rows="5" disabled name="keterangan" class="form-control no-resize"><?php echo $e['keterangan'];?></textarea>
                                        </div>
                                    </div>
									

									<br>
                                    <a href="edit_barang.php?kd=<?php echo $e['kd_barang'];?>"><button type="button" name="simpan" class="btn btn-primary m-t-15 waves-effect">Edit</button></a>
                                    <a href="delete_barang.php?kd=<?php echo $e['id'];?>"><button type="button" class="btn btn-success m-t-15 waves-effect">Hapus</button></a>
									<a href="daftar_barang.php"><button type="button" class="btn btn-warning m-t-15 waves-effect">Keluar</button></a>
								</div>
