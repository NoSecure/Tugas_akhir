								...
								<div class="col-md-6">
									<div class="form-group">
                                        <div class="">
                                            ...
                                            <input type="hidden" name="id" id="id" value="<?php echo $e['id'];?>" class="form-control">
                                            <input type="hidden" name="kd_barang" id="kd_barang" value="<?php echo $e['kd_barang'];?>" class="form-control">
									<label for="nama_barang">Nama Barang</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_barang" value="<?php echo $e['nama_barang'];?>" class="form-control">
                                        </div>
                                    </div>
									<label for="tolol">Harga</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="harga_satuan" id="" class="form-control" value="<?php echo $e['harga_satuan'];?>">
                                        </div>
                                    </div>
									<label for="tolol">Stock</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="stock_barang" class="form-control" value="<?php if($e['stock_barang']<1){echo "0";} else{echo $e['stock_barang']; } ?>">
                                        </div>
                                    </div>
                                    <p>
                                        <b>Kategori</b>
                                    ...
                                    <select name="kategori" class="form-control show-tick">
                                        <option value="pria" <?php if ($e['kategori']=="pria") {echo "selected=\"selected\""; } ?>>Pria</option>
                                        <option value="wanita" <?php if ($e['kategori']=="wanita") {echo "selected=\"selected\""; } ?>>Wanita</option>
                                        <option value="anak" <?php if ($e['kategori']=="anak") {echo "selected=\"selected\""; } ?>>Anak</option>
                                        <option value="terbaru" <?php if ($e['kategori']=="terbaru") {echo "selected=\"selected\""; } ?>>Terbaru</option>
                                    </select><br><br>
									<label for="tolol">Keterangan</label>
									<div class="form-group">
                                        <div class="form-line">
                                            <textarea cols="30" rows="5" name="keterangan" class="form-control no-resize"><?php echo $e['keterangan'];?></textarea>
                                        </div>
                                    </div>
