                ...
                <div class="col-md-12" id="basket">
                    <div class="box">
                        <form method="post" action="checkout1.php">
                            ...
                            <p class="text-muted">Semua belanjaan anda ada di sini</p>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_SESSION['items'])) {
                                            foreach ($_SESSION['items'] as $key => $val) {
                                                ...
                                                $total = $jumlah_harga;
												$_SESSION['pemilik']=$data['pemilik'];
												$_SESSION['kd_barang']=$data['kd_barang'];
												$_SESSION['nama_barang']=$data['nama_barang'];
												$_SESSION['quantity']=$val;
												$_SESSION['harga_satuan']=$data['harga_satuan'];
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php echo $data['harga_satuan']; ?></center></td>
                                            <td><center><?php echo $val; ?></center></td>
                                            <td><center><?php echo number_format($total,3,",",","); ?></center></td>
                                            <td><center><a href="cart.php?act=plus&amp;id=<?php echo $key; ?>&amp;ref=basket.php" class="fa fa-plus"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cart.php?act=min&amp;id=<?php echo $key; ?>&amp;ref=basket.php" class="fa fa-minus"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cart.php?act=del&amp;id=<?php echo $key; ?>&amp;ref=basket.php" class="fa fa-trash-o"></a></center></td>
                                        </tr>
                                    </tbody>
                                    <?php			
                                            }
                                    ...
                                    <?php
                                    if($total == 0){
                                        echo '<tr><td colspan="7" align="center">Ups, Keranjang kosong!</td></tr></table>';
                                        echo '<p><div align="right">
                                        </div></p>';
                                    } else {
                                        echo '
                                        <tr style="background-color: #DDD;"></tr></table>
                                        <p><div align="right">
                                        <a href="checkout1.php?total='.$total.'" class="btn btn-primary">CHECK OUT<i class="fa fa-chevron-right"></i></a>
                                        </div></p>
					                       ';
                                    }
				                    ?>
