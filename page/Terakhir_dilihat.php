                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="alert alert-warning alert-dismissible">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <strong>Maaf!&nbsp;&nbsp;&nbsp;</strong>Kami Sedang Melakukan Perbaikan.
                                </div>
                            <div class="box">
                                <p class="text-center">
                                    <img src="img/danger.png" style="height:50px; width:50px;" alt="Obaju template">
                                </p>
                                <h3></h3>
                                <h4 class="text-muted">
                                    Maaf, atas ketidak nyamananya, kami sedang melakukan perbaikan terhadap site ini<br>
                                </h4>
                                <p class="buttons"><a href="../index.php" class="btn btn-primary"><i class="fa fa-home"></i>Kembali ke Beranda</a>
                                </p>
                            </div>
                        </div>
                    </div>
