                    ...
                    <div class="box">
                        <form method="post" action="pembeli.php">
                            <?php
                                ...
                                include("../koneksi.php");
                                $query = mysqli_query($koneksi, "SELECT max(id_pesanan) as maxKode FROM pemesanan");
                                $data = mysqli_fetch_array($query);
                                $kodeBarang = $data['maxKode'];
                                $noUrut = (int) substr($kodeBarang, 3, 3);
                                $noUrut++;
                                $char = "PEM";
                                $id_pesanan = $char . sprintf("%03s", $noUrut);
								$_SESSION['id_pesanan']=$id_pesanan;
								$nama_barang=$_SESSION['nama_barang'];
								$kd_barang=$_SESSION['kd_barang'];
								$quantity=$_SESSION['quantity'];
								$harga_satuan=$_SESSION['harga_satuan'];	
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li class="disabled"><a href="#"><i class="fa fa-eye"></i><br>Lihat Pembelian</a>
                                </li>
                            </ul>
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="firstname">Id Pesanan</label>
                                            <input type="text" class="form-control" id="id_pesanan" name="id_pesanan" readonly value="<?php echo $id_pesanan;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
											...
											<input type="hidden" class="form-control" id="pemilik" name="pemilik" readonly value="<?php echo $pemilik;?>">
											<input type="hidden" class="form-control" id="kd_barang" name="kd_barang" readonly value="<?php echo $kd_barang;?>">
                                            <input type="hidden" class="form-control" id="nama_barang" readonly value="<?php echo $nama_barang;?>" name="nama_barang">
                                            <input type="hidden" class="form-control" readonly value="<?php echo $quantity; ?>" id="quantity" name="quantity">
                                            <input type="hidden" class="form-control" readonly value="<?php echo abs((int)$_GET['total']); ?>" id="total" name="total">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="firstname">No Telephone</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?php echo $tgl;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                   <div class="form-group">
                                       <label>Alamat : </label>
                                       <textarea name="alamat" class="form-control" row="8"></textarea>
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="metode_pembayaran" name="metode_pembayaran" class="form-control">
                                        ...
                                        <option value="Bayar Di konter">Bayar Di konter</option>
                                    </select>
                                </div>
                            </div>
                            <div class="box-footer">
                                <div class="pull-right">
                                    <button type="submit" id="simpan" class="btn btn-default">Selesai</button>&nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
                        </form>
                    </div>
