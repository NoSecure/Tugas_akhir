            ...
            <div class="navbar-collapse collapse" id="navigation">
               <ul class="nav navbar-nav navbar-left">
                    <li class="dropdown yamm-fw">
						<a href="../index.php" data-hover="dropdown" data-delay="200">Beranda</a>
                    </li>
                    <li class="dropdown yamm-fw">
        ...
        <div id="content">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <h1>Hay</h1>
                        <p>kami menyediakan banyak pilihan untuk fashion anak anda.</p>
                    </div>
                    <div class="row products"><?php
                                include("../koneksi.php");
                                $sql = "SELECT * FROM barang where kategori='anak' AND stock_barang > 0";
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <a href="../detail.php?kd=<?php echo $data['id'];?>" class="invisible">
                                    <img src="../admin/file/<?php echo $data['gambar'];?>" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    ...
                                    <p class="buttons">
                                        <a href="../page/detail.php?kd=<?php echo $data['id'];?>" class="btn btn-default">View detail</a>
